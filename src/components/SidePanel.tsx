...
export default function SidePanel({ isVisible, toggleVisibility }: Readonly<SidePanelProps>) {

    const [activePage, setActivePage] = useState(window.location.pathname.replace("/", "")); // Track the active page
    ...
    function onNavClick(e: React.MouseEvent<HTMLButtonElement>) {
        ...
        if (clickedPage === "payments" || clickedPage === "") { // TODO: Remove this when all pages are implemented
    ...
    return (
        <div className="grow min-w-[250px] max-w-[325px] h-screen flex flex-col bg-[#FCFCFE] pt-3 items-center gap-5 font-semibold border-r border-gray-300">
            ...
            <div className="flex flex-row -ml-1 mb-4 items-center justify-between w-5/6"> {/* Atlar logo */}
                <img src={atlarSvg} alt="Atlar logo" width={40} className={`aspect-square `}/>
                <button onClick={toggleVisibility}> 
                    <img src="/images/close-x.svg" alt="Close menu" width={25} className="hover:drop-shadow-lg"/>
                </button>
            </div>
            ...
            <button 
                ...
                value=""> 
                <img src={houseSvg} alt="House icon" width={iconSize} className="aspect-square"/>
                <span>Home</span>
            </button>
            ...
            <button 
                ...
                value="payments"> 
                <img src={paymentSvg} alt="Arrows icon" width={iconSize} className="aspect-square"/>
                <span>Payments</span>
            </button>
